...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', '-p', type=str,
                        default='./origin_mydataset'.format(Path.home()))
    # parser.add_argument('--out', '-o', type=str,
    #                     default='./dataset/celebahq')
    parser.add_argument('--out', '-o', type=str,
                        default='./dataset/mydataset')
    
    parser.add_argument('--size', type=str, default='64,512')   # '64,512'
    parser.add_argument('--n_worker', type=int, default=0)          # 3
...
# python data/prepare_data.py  --path ./origin_mydataset_train  --out ./dataset/mydataset_train --size 64,256 